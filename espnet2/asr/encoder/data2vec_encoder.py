...
class FairSeqData2VecEncoder(AbsEncoder):
    ...
    def __init__(
        ...
        if os.path.exists('/workspace/dohee/models/audio_base_ls.pt'):
            self.w2v_model_path = '/workspace/dohee/models/audio_base_ls.pt'
